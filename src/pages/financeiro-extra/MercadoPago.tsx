    ...
    <div>
      <header className="rounded-lg border mb-6 overflow-hidden shadow" aria-label="Configuração do Mercado Pago">
        <div className="px-4 py-3 text-primary-foreground" style={{ background: "var(--gradient-primary)" }}>
          ...
          <p className="text-xs/6 opacity-90">Configure seu gateway de pagamentos Mercado Pago.</p>
        </div>
      </header>
      ...
      <main className="space-y-4">
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              A integração com o Mercado Pago está em desenvolvimento e será disponibilizada em breve.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Em breve você poderá configurar o Mercado Pago como gateway de pagamentos para seus clientes.
            </p>
          </CardContent>
        </Card>
      </main>
